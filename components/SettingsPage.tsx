  ...
  return (
    ...
    >
      <motion.div variants={item}>
        <Card className="p-6 shadow-md bg-white rounded-xl border border-pink-100">
          ...
          <RadioGroup
            ...
            className="space-y-3"
          >
            <div className="flex items-center space-x-2 p-3 rounded hover:bg-pink-50 transition-colors">
